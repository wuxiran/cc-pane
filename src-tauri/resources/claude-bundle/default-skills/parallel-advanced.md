...
description: Same-project parallel orchestration: read-only research via sub-agents, code changes via worktree workers. 触发词：并行改同一个项目、隔离着并行。代码型并行必须搭配 worktree 隔离。
---
