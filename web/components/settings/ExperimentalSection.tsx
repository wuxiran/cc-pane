...
import { Clapperboard, FlaskConical, Store } from "lucide-react";
...
const FEATURES: {
  ...
  labelKey: "experimental.dramaStudio" | "experimental.skillMarket";
  descKey: "experimental.dramaStudioDesc" | "experimental.skillMarketDesc";
}[] = [
  {
    id: "dramaStudio",
    icon: Clapperboard,
