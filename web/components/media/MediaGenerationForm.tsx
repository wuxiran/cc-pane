...
export default function MediaGenerationForm({ kind, providerId = null, modelId, protocol = "open_ai_compatible", capabilities = null, disabled = false, linkedInput = null, onClearLinkedInput, onGenerate }: MediaGenerationFormProps) {
