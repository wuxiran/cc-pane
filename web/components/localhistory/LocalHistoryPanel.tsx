...
import { History, RotateCcw, FileText, Tag, Trash2, Diff, Code, GitBranch, ChevronLeft, FolderOpen } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export default function LocalHistoryPanel({
  ...
  const {
    ...
    handleKeydown,
    getVersionLabels,
  } = useLocalHistoryData({ open, projectPath, filePath, onOpenChange, onRestored });
